...
def accuracy_reward(completions, solution, logger=None, **kwargs):
    ...
    # You'll need access to your listener model and image data
    # These should be passed via kwargs or be accessible globally
    path_candidates = kwargs.get('ret_paths')  # List of candidate image paths for each example
    category = kwargs.get('category')
    for i, (content, sol) in enumerate(zip(contents, solution)):
        # content: Generated description from speaker
        # sol: Ground truth index of correct image
        # image_candidates[i]: List of candidate images for this example
        cat = category[i]
        ...
        # try:
        # Get the candidate images for this example
        ...
        # Get listener predictions for all candidates
        ...
        # Extract yes probabilities and find predicted index
