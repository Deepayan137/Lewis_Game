...
# python compute_recognition_metrics.py --method RePIC --dataset MyVLM --results_dir results_RePIC/MyVLM/all --file_identifier recognition_result.json --seed 23

# python compute_recognition_metrics.py --method RAP --dataset YoLLaVA --results_dir results_RAP_QWEN/YoLLaVA/all --file_identifier reco_results.json --seed 23

# python compute_recognition_metrics.py --method ours --dataset MyVLM --results_dir results_ours/MyVLM/all --file_identifier reco_results.json --seed 23